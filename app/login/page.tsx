  ...
  return (
    <div className={`login-page min-h-[100vh] my-[60px]   flex items-center relative bg-white ${spaceGrotesk.className} `}>
      ...
      <div className="form-wrapper w-full   mx-auto px-[20px] md:px-[80px] ">
        <form
          action=""
          className="backdrop-blur-3xl  bg-white/60 border border-gray-200  relative mx-auto md:mr-[60px] max-w-[415px] 4xl:max-w-[524px]  rounded-[10px] p-[37px] 4xl:p-[48.6px] !pb-[60px] 4xl:!pb-[70px]  shadow-[9px_9px_0px_#5435F5] "
        >
          <div className="hidden md:block absolute top-0 right-[0]  transform-[translate(50%,-20%)] shadow-[0px_2px_10px_rgba(0,0,0,0.1)]">
            <Image src={logo} alt="Logo" className="max-w-[118px]" />
          </div>
          <h1 className={`text-[34px] 4xl:text-[42px]  text-center mb-[52px] 4xl:mb-[76px] text-transparent bg-clip-text bg-[linear-gradient(to_left,_#000000_22%,_#292929_61%,_#666666_80%)] ${kronaOne.className}`}>
            Welcome
          </h1>
          <h4 className="text-[19px] 4xl:text-[24px] tracking-[0.18px] font-medium mb-[22px] 4xl:mb-[33px]">Log in to your Account</h4>

          <div className="field text-[12px] 4xl:text-[16px] mb-[18px] 4xl:mb-[25.5px]">
            <label htmlFor="login-username" className="mb-[8px] 4xl:mb-[12px] block">
              User Name
            </label>
            <input
              type="text"
