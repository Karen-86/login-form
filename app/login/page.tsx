  ...
  return (
    <div className={`login-page min-h-[100vh]  flex items-center relative bg-white ${spaceGrotesk.className} `}>
      ...
      <div className="form-wrapper w-full  mx-auto px-[20px] md:px-[80px]">
        <form
          action=""
          className="backdrop-blur-3xl  bg-white/60 border border-gray-200  relative mx-auto md:mr-[60px]  max-w-[524px]  rounded-[10px] p-[43px] pb-[80px] shadow-[9px_9px_0px_#5435F5] "
        >
          ...
          <h1 className={`text-[42px] text-center mb-[66px] text-transparent bg-clip-text bg-[linear-gradient(to_left,_#000000_22%,_#292929_61%,_#666666_80%)] ${kronaOne.className}`}>
            Welcome
          </h1>
          <h4 className="text-[24px] tracking-[0.18px] font-medium mb-[33px]">Login to your Account</h4>

          <div className="field text-[14px] mb-[25px]">
            ...
            <input
              ...
              className="bg-white px-3 py-[10px] block w-full border border-gray-300 rounded-[7px] text-[16px]"
            />
          </div>
          ...
          <button className="btn cursor-pointer text-[20px]  px-3 py-2 bg-[#2C2C2C] hover:bg-[#000]  text-white rounded-[7px] text-center block w-full   mb-[14px]">
            Login
          </button>

          <div className="form-footer text-center">
            <a href="#/" className="hover:underline text-center text-[18px]">
              Forget Password?
            </a>
          </div>
        </form>
